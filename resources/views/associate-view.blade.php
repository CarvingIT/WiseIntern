...
<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
			...
			<div class="mt-6 text-gray-900">
				<div class="m-1">
			        <p class="text-xl">Name:-{{$user->name}} </p>	
				</div>
				<div class="m-1">
			        <p class="text-xl">Associate Type:-{{$user->type}}</p>	
				</div>
				<div class="m-1">
			        <p class="text-xl">Address:-{{$user->address}}</p>	
				</div>
				<div class="m-1">
			        <p class="text-xl">Email:-{{$user->email}}</p>	
				</div>
				<div class="m-1">
			        <p class="text-xl">Phone1:-{{$user->phone1}}</p>	
				</div>
				<div class="m-1">
			        <p class="text-xl">Phone2:-{{$user->phone2}}</p>	
				</div>
				</br>
