<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="/admin/usermanagement" :active="request()->routeIs('/admin/usermanagement')">
                {{ __('Users') }}
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="/admin/projects" :active="request()->routeIs('/admin/projects')">
                {{ __('Projects') }}
            </x-jet-responsive-nav-link>
        </div>
